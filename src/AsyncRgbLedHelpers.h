...
struct RGBWValue
{
    ...
    RGBWValue( U16 r, U16 g, U16 b, U16 w ) : red( r ), green( g ), blue( b ), white( w )
    {
        ;
    }
  ...
  //  U16 padding = 0; // no alpha in LED colors
    ...
    static RGBWValue CreateFromControllerOrder( ColorLayout layout, U16* values );

    static RGBWValue CreateFromU64( U64 raw );

...
class AsyncRgbLedAnalyzerResults : public AnalyzerResults
{
  public:
    ...
    //virtual ~AsyncRgbwLedAnalyzerResults();
  ...
  private:
    ...
    void GenerateRGBWStrings( const RGBWValue& rgb, DisplayBase base, size_t bufSize, char* redBuf, char* greenBuff, char* blueBuf, char* whiteBuf);
};
